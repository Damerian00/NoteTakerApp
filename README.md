...
<!-- ABOUT THE PROJECT -->
## About The Project
  My work on this project was done on the back-end by using fetch requests like get, post, and delete to update a JSON file that stored the data that a user input into the application. It uses node.js, heroku, file system, express, and other libraries to complete this task.



![Project Preview](./assets/site_ss.png)



![Project Preview](./assets/site2_ss.png)
